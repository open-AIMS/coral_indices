...
CI_models_CC_aggregation(level = 'BIOREGION.agg') 
CI_models_CC_aggregation(level = 'NRM') 
CI_models_CC_aggregation(level = 'TUMRA') 
CI_models_CC_aggregation(level = 'GBRMPA.MA') 
CI_models_CC_aggregation(level = 'GBRMP') 
